...
/*   Updated: 2024/07/21 15:50:20 by lluque           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_ft_mx	*fdf_get_vertex_mx_cyl(t_ft_mx **map_mx, double r, double h)
{
	...
	{
		v_mx->d[v] = fdf_get_cyl_x(j, i, map_mx[Z], r);
		v_mx->d[map_mx[Z]->m * map_mx[Z]->n + v] = fdf_get_cyl_y(j, i, map_mx[Z], r);
		v_mx->d[2 * map_mx[Z]->m * map_mx[Z]->n + v] = fdf_get_cyl_z(i, map_mx[Z], h);
